...
WSSHClient.prototype._generateEndpoint = function(options) {
    ...
    if (options.authentication_method == 'password') {
      ...
      endpoint += '?private_key=' + encodeURIComponent(options.private_key) + '&port=' + encodeURIComponent(options.port);
      if(options.key_passphrase !== undefined) endpoint += '&key_passphrase=' + encodeURIComponent(options.key_passphrase);
    }
    return endpoint;
};
